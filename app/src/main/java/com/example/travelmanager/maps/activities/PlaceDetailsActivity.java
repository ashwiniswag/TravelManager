...
import com.example.travelmanager.maps.models.Photos;
...
public class PlaceDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String photoUrl = String.format("https://maps.googleapis.com/maps/api/place/photo?maxwidth=%s&photoreference=%s&key=%s", 400, photos.getPhoto_reference(), "AIzaSyDYoQybddM6c-Daz0bHVe7h2tuyzxHmW1k");
